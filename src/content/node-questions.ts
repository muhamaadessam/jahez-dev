// Generated by scripts/build-node-questions.ts
...
export const nodeBaseQuestions: Omit<InterviewQuestion, "translations">[] = [
  {
    ...
    "commonMistakes": [
      "الاعتقاد بأن setTimeout(fn, 0) تنفذ فوراً في نفس اللحظة دون انتظار دورة الـ event loop.",
      "تجاهل أولوية process.nextTick على الـ microtasks الأخرى للـ Promise."
    ],
    "followUpQuestions": [
      "كيف يؤثر تنفيذ عملية متزامنة ثقيلة داخل مرحلة Poll على الـ Timers؟",
      "ما الفرق الدقيق بين تنفيذ الـ microtasks في Node.js 11+ مقارنة بالإصدارات السابقة؟"
    ],
    "sources": [
      {
        "title": "Node.js docs — The Node.js Event Loop, Timers, and process.nextTick()",
        "url": "https://nodejs.org/docs/latest/api/timers.html"
      }
    ],
  ...
  },
  {
    ...
    "commonMistakes": [
      "استخدام process.nextTick في استدعاءات عودية مما يتسبب في تجميد كامل الـ I/O."
    ],
    "followUpQuestions": [
      "متى يكون من الضروري استخدام process.nextTick للسماح للمستخدم بالاشتراك في الأحداث قبل إطلاقها؟"
    ],
    "sources": [
      {
        "title": "Node.js docs — process.nextTick",
        "url": "https://nodejs.org/docs/latest/api/process.html#processnexttickcallback-args"
      }
    ],
    "lastReviewedAt": "2026-09-07"
  },
  {
    ...
    "commonMistakes": [
      "الاعتقاد بأن كل طلبات الشبكة تستهلك threads من الـ libuv thread pool."
    ],
    "followUpQuestions": [
      "كيف تراقب تشبع الـ thread pool واختناق عمليات الـ I/O في بيئة الإنتاج؟"
    ],
    "sources": [
      {
        "title": "Node.js docs — Dependencies: libuv",
  ...
  },
  {
    ...
    "commonMistakes": [
      "الاحتفاظ بمراجع غير مباشرة لكائنات ضخمة في مصفوفات عامة تمنع الـ GC من تحريرها."
    ],
    "followUpQuestions": [
      "ما الفرق بين Stop-the-world GC والـ Incremental Marking في V8؟"
    ],
    "sources": [
      {
        "title": "Node.js docs — v8 module",
        "url": "https://nodejs.org/docs/latest/api/v8.html"
      }
    ],
    "lastReviewedAt": "2026-09-07"
  },
  {
    ...
    "commonMistakes": [
      "تنفيذ عمليات معالجة مكثفة للـ CPU مباشرة في الخيط الرئيسي مما يجمد كل الطلبات الأخرى."
    ],
    "followUpQuestions": [
      "كيف تحل مشكلة المهام المعتمدة على الـ CPU دون تعطيل الخادم؟"
    ],
    "sources": [
      {
        "title": "Node.js docs — Overview of Blocking vs Non-Blocking",
        "url": "https://nodejs.org/docs/latest/api/net.html"
      }
    ],
    "lastReviewedAt": "2026-09-07"
  },
  {
    ...
    "commonMistakes": [
      "محاولة استكمال عمل السيرفر بعد uncaughtException مما يؤدي إلى تلف البيانات أو تسريب الذاكرة."
    ],
    "followUpQuestions": [
      "لماذا يعتبر الإبقاء على العملية حية بعد uncaughtException سلوكاً خطيراً؟"
    ],
    "sources": [
      {
        "title": "Node.js docs — process events",
        "url": "https://nodejs.org/docs/latest/api/process.html#event-uncaughtexception"
      }
    ],
    "lastReviewedAt": "2026-09-07"
  },
  {
    ...
    "commonMistakes": [
      "عدم وضع مهلة زمنية قسرية في حالة وجود طلب عالق أو اتصال مفتوح بلا نهاية."
    ],
    "followUpQuestions": [
      "ما أهمية استدعاء .unref() على مؤقت الـ shutdown timeout؟"
    ],
    "sources": [
      {
        "title": "Node.js docs — Process Signal Events",
        "url": "https://nodejs.org/docs/latest/api/process.html#signal-events"
      }
    ],
    "lastReviewedAt": "2026-09-07"
  },
  {
    ...
    "commonMistakes": [
      "زيادة الحد عبر setMaxListeners(100) لإخفاء التحذير دون التحقق من وجود تسريب حقيقي."
    ],
    "followUpQuestions": [
      "ما الفرق بين .once() و .on() مع AbortSignal في الإصدارات الحديثة؟"
    ],
    "sources": [
      {
  ...
  },
  {
    ...
    "commonMistakes": [
      "نسيان التقاط AbortError في كتلة الـ catch وتصنيفه كخطأ غير متوقع للخادم."
    ],
    "followUpQuestions": [
      "كيف تستخدم AbortSignal.timeout(ms) لتبسيط إدارة مهل الطلبات في Node.js 18+؟"
    ],
    "sources": [
      {
        "title": "Node.js docs — AbortController",
        "url": "https://nodejs.org/docs/latest/api/globals.html#abortcontroller"
      }
    ],
    "lastReviewedAt": "2026-09-07"
  },
  {
    ...
    "commonMistakes": [
      "الافتراض بأن كتابة الكود بـ C++ ستكون أسرع دائماً مع تجاهل تكلفة نقل البيانات وتجاوز حدود V8."
    ],
    "followUpQuestions": [
      "ما هو دور node-addon-api في تبسيط كتابة الـ Addons باستخدام C++؟"
    ],
    "sources": [
      {
        "title": "Node.js docs — C/C++ addons",
        "url": "https://nodejs.org/docs/latest/api/addons.html"
      }
    ],
    "lastReviewedAt": "2026-09-07"
  },
  {
    ...
    "commonMistakes": [
      "نسيان إضافة كلمة await مما يعيد كائن Promise بدلاً من القيمة المطلوبة وينتج أخطاء صامتة."
    ],
    "followUpQuestions": [
      "ما هو التأثير الأدائي لاستخدام await المتسلسلة لعمليات غير معتمدة على بعضها؟"
    ],
    "sources": [
      {
        "title": "Node.js docs — Asynchronous activity",
        "url": "https://nodejs.org/docs/latest/api/async_context.html"
      }
    ],
    "lastReviewedAt": "2026-09-07"
  },
  {
    ...
    "commonMistakes": [
      "استخدام Promise.all لمجموعة طلبات خارجية دون معالجة احتمال فشل أحدها مما يفقد بيانات الطلبات الناجحة."
    ],
    "followUpQuestions": [
      "متى تفضل استخدام Promise.any على Promise.race؟"
    ],
    "sources": [
      {
        "title": "Node.js docs — JavaScript globals",
  ...
  },
  {
    ...
    "commonMistakes": [
      "الاعتقاد بأن Node.js تضع حداً تلقائياً لعدد الوعود المتزامنة التي يطلقها Promise.all."
    ],
    "followUpQuestions": [
      "كيف توازن بين حجم الـ concurrency limit وسرعة إنهاء المهام دون التأثير على زمن استجابة السيرفر؟"
    ],
    "sources": [
      {
        "title": "Node.js docs — net module",
        "url": "https://nodejs.org/docs/latest/api/net.html"
      }
    ],
    "lastReviewedAt": "2026-09-07"
  },
  {
    ...
    "commonMistakes": [
      "فقدان السياق غير المتزامن عند التعامل مع مكتبات قديمة تستخدم كوداً متزامناً يقطع الـ callback chain."
    ],
    "followUpQuestions": [
      "ما هو العبء الأدائي الناتج عن تفعيل AsyncLocalStorage في الخدمات عالية الحِمل؟"
    ],
    "sources": [
      {
        "title": "Node.js docs — AsyncLocalStorage",
        "url": "https://nodejs.org/docs/latest/api/async_context.html#class-asynclocalstorage"
      }
    ],
    "lastReviewedAt": "2026-09-07"
  },
  {
    ...
    "commonMistakes": [
      "وضع حلقة غير متناهية داخل queueMicrotask أو process.nextTick مما يحجب الـ Event Loop تماماً عن أي I/O."
    ],
    "followUpQuestions": [
      "لماذا صُمم process.nextTick ليكون له أولوية أعلى من microtasks الخاصة بـ Promise؟"
    ],
    "sources": [
      {
        "title": "Node.js docs — Timers and nextTick",
        "url": "https://nodejs.org/docs/latest/api/timers.html"
      }
    ],
    "lastReviewedAt": "2026-09-07"
  },
  {
    ...
    "commonMistakes": [
      "رمي الأخطاء بـ throw داخل دالة الـ callback العادية بدلاً من تمريرها للمعامل الأول (err)."
    ],
    "followUpQuestions": [
      "كيف تقوم أداة util.promisify بتحويل دوال الـ callback تلقائياً؟"
    ],
    "sources": [
      {
  ...
  },
  {
    ...
    "commonMistakes": [
      "الاعتماد على process.nextTick لتقطيع المهام، حيث يظل الطابور محتكراً للخيط ويمنع معالجة أحداث الـ I/O."
    ],
    "followUpQuestions": [
      "متى يكون استخدام Worker Threads أفضل من تقطيع المهمة داخل الـ main thread؟"
    ],
    "sources": [
      {
        "title": "Node.js docs — Don't Block the Event Loop",
        "url": "https://nodejs.org/docs/latest/api/perf_hooks.html"
      }
    ],
    "lastReviewedAt": "2026-09-07"
  },
  {
    ...
    "commonMistakes": [
      "استخدام Top-level await لمهام طويلة الأمد وغير حرجة مما يرفع زمن إقلاع السيرفر (Cold Start)."
    ],
    "followUpQuestions": [
      "كيف تتعامل مع أخطاء الـ Rejection الناتجة عن Top-Level Await أثناء استيراد الموديول؟"
    ],
    "sources": [
      {
        "title": "Node.js docs — ES Modules: Top-level await",
        "url": "https://nodejs.org/docs/latest/api/esm.html#top-level-await"
      }
    ],
    "lastReviewedAt": "2026-09-07"
  },
  {
    ...
    "commonMistakes": [
      "عدم التعامل مع أخطاء الـ stream داخل حلقة for await مما يسبب unhandled rejection."
    ],
    "followUpQuestions": [
      "كيف تنشئ Async Generator مخصصاً لقراءة صفحات بيانات من API خارجي على دفعات؟"
    ],
    "sources": [
      {
        "title": "Node.js docs — Stream as an async iterable",
        "url": "https://nodejs.org/docs/latest/api/stream.html#streams-as-async-iterables"
      }
    ],
    "lastReviewedAt": "2026-09-07"
  },
  {
    ...
    "commonMistakes": [
      "استخدام using العادية بدلاً من await using مع الموارد التي تتطلب تنظيفاً غير متزامن."
    ],
    "followUpQuestions": [
      "كيف يدعم TypeScript 5.2+ ميزة await using عند ترجمة كود Node.js؟"
    ],
    "sources": [
      {
        "title": "Node.js docs — Global Symbols and Objects",
        "url": "https://nodejs.org/docs/latest/api/globals.html"
      }
    ],
    "lastReviewedAt": "2026-09-07"
  },
  {
    ...
    "commonMistakes": [
      "قراءة ملفات بحجم جيجابايت باستخدام fs.readFile في الذاكرة بدلاً من استخدام الـ Streams."
    ],
    "followUpQuestions": [
      "ما الفرق الدقيق بين Duplex Stream و Transform Stream؟"
    ],
    "sources": [
      {
        "title": "Node.js docs — Stream module",
  ...
  },
  {
    ...
    "commonMistakes": [
      "تجاهل القيمة المعادة من writer.write() ومواصلة ضخ البيانات مما يؤدي لزيادة استهلاك الذاكرة."
    ],
    "followUpQuestions": [
      "كيف تقوم utility مثل stream.pipeline بإدارة الـ backpressure تلقائياً بين عدة streams؟"
    ],
    "sources": [
      {
        "title": "Node.js docs — Backpressuring in Streams",
        "url": "https://nodejs.org/docs/latest/api/stream.html#backpressuring-in-streams"
      }
    ],
    "lastReviewedAt": "2026-09-07"
  },
  {
    ...
    "commonMistakes": [
      "استخدام .pipe() بدون الاستماع لأحداث error على كل stream في السلسلة."
    ],
    "followUpQuestions": [
      "كيف تتعامل pipeline مع إشارات الإلغاء عبر AbortSignal؟"
    ],
    "sources": [
      {
        "title": "Node.js docs — stream.pipeline",
        "url": "https://nodejs.org/docs/latest/api/stream.html#streampipelinesource-transforms-destination-callback"
      }
    ],
    "lastReviewedAt": "2026-09-07"
  },
  {
    ...
    "commonMistakes": [
      "إرسال Buffer.allocUnsafe عبر الشبكة دون الكتابة فوقه بالكامل، مما قد يسرب بيانات حساسة."
    ],
    "followUpQuestions": [
      "كيف يرتبط كائن Buffer بـ Uint8Array المعياري في JavaScript الحديثة؟"
    ],
    "sources": [
      {
  ...
  },
  {
    ...
    "commonMistakes": [
      "رفع highWaterMark لأحجام مفرطة مع خوادم تستقبل آلاف الاتصالات المتزامنة."
    ],
    "followUpQuestions": [
      "كيف تختلف دلالة highWaterMark عندما يكون الـ Stream في وضع objectMode؟"
    ],
    "sources": [
      {
        "title": "Node.js docs — Buffering and highWaterMark",
        "url": "https://nodejs.org/docs/latest/api/stream.html#buffering"
      }
    ],
    "lastReviewedAt": "2026-09-07"
  },
  {
    ...
    "commonMistakes": [
      "حفظ محتويات الملف في متغيرات داخلية في الذاكرة قبل كتابتها على القرص."
    ],
    "followUpQuestions": [
      "كيف تحسب بصمة التشفير (SHA-256) للملف أثناء تدفقه دون إعادة قراءته من جديد؟"
    ],
    "sources": [
      {
        "title": "Node.js docs — HTTP Request and Streams",
  ...
  },
  {
    ...
    "commonMistakes": [
      "نسيان استدعاء callback() في نهاية _transform مما يؤدي لتوقف وتجمد التدفق."
    ],
    "followUpQuestions": [
      "ما أهمية تنفيذ دالة _flush() الاختيارية في Transform stream؟"
    ],
    "sources": [
      {
        "title": "Node.js docs — Implementing a Transform Stream",
        "url": "https://nodejs.org/docs/latest/api/stream.html#implementing-a-transform-stream"
      }
    ],
    "lastReviewedAt": "2026-09-07"
  },
  {
    ...
    "commonMistakes": [
      "استخدام fs.readFileSync في مسارات معالجة طلبات الـ HTTP مما يجمد الخادم للعملاء الآخرين."
    ],
    "followUpQuestions": [
      "كيف يؤثر الـ OS caching على سرعة القراءة عبر fs streams؟"
    ],
    "sources": [
      {
        "title": "Node.js docs — fs.createReadStream",
        "url": "https://nodejs.org/docs/latest/api/fs.html#fscreatereadstreampath-options"
      }
    ],
    "lastReviewedAt": "2026-09-07"
  },
  {
    ...
    "commonMistakes": [
      "ربط stream بوضع objectMode مباشرة مع writable stream يتوقع بايتات ثنائية دون تسلسل."
    ],
    "followUpQuestions": [
      "كيف تتغير طريقة حساب highWaterMark في وضع objectMode؟"
    ],
    "sources": [
      {
        "title": "Node.js docs — Object mode",
        "url": "https://nodejs.org/docs/latest/api/stream.html#object-mode"
      }
    ],
    "lastReviewedAt": "2026-09-07"
  },
  {
    ...
    "commonMistakes": [
      "افتراض أن انتهاء الدالة يغلق الـ stream تلقائياً دون الحاجة لتدميره في كتلة catch."
    ],
    "followUpQuestions": [
      "ما الفرق بين حدث 'finish' وحدث 'close' في الـ Writable streams؟"
    ],
    "sources": [
      {
        "title": "Node.js docs — stream.destroy",
        "url": "https://nodejs.org/docs/latest/api/stream.html#writabledestroyerror"
      }
    ],
    "lastReviewedAt": "2026-09-07"
  },
  {
    ...
    "commonMistakes": [
      "محاولة استخدام require() داخل ملفات ESM دون إنشاء require مخصص عبر createRequire."
    ],
    "followUpQuestions": [
      "كيف تستخرج __dirname في ES Modules باستخدام وحدة node:url؟"
    ],
    "sources": [
      {
        "title": "Node.js docs — Modules: CommonJS and ECMAScript modules",
        "url": "https://nodejs.org/docs/latest/api/esm.html"
      }
    ],
    "lastReviewedAt": "2026-09-07"
  },
  {
    ...
    "commonMistakes": [
      "نسيان توفير حقل types أو وضعه في مكان خاطئ في exports."
    ],
    "followUpQuestions": [
      "كيف يتعامل خيار conditional exports مع بيئات مثل browser أو development؟"
    ],
    "sources": [
      {
        "title": "Node.js docs — Package entry points",
        "url": "https://nodejs.org/docs/latest/api/packages.html#package-entry-points"
      }
    ],
    "lastReviewedAt": "2026-09-07"
  },
  {
    ...
    "commonMistakes": [
      "الاعتماد على ترتيب الاستيراد العشوائي لإخفاء أخطاء التبعية الدائرية."
    ],
    "followUpQuestions": [
      "كيف تساعد أدوات مثل madge في اكتشاف التبعيات الدائرية تلقائياً في المشروع؟"
    ],
    "sources": [
      {
        "title": "Node.js docs — Cycles in Modules",
        "url": "https://nodejs.org/docs/latest/api/modules.html#cycles"
      }
    ],
    "lastReviewedAt": "2026-09-07"
  },
  {
    ...
    "commonMistakes": [
      "تعديل أو حذف package-lock.json يدوياً لحل تعارضات التثبيت."
    ],
    "followUpQuestions": [
      "لماذا ينصح دائماً بوضع --ignore-scripts في بيئات الـ CI عند استخدام npm ci؟"
    ],
    "sources": [
      {
        "title": "Node.js docs — package-lock.json concept",
  ...
  },
  {
    ...
    "commonMistakes": [
      "تثبيت إصدارات متعارضة من نفس الحزمة الأساسية في حزم الـ monorepo المختلفة."
    ],
    "followUpQuestions": [
      "كيف تحل pnpm مشكلة الـ phantom dependencies مقارنة بـ npm التقليدي؟"
    ],
    "sources": [
      {
        "title": "Node.js docs — Package Manager Integration",
        "url": "https://nodejs.org/docs/latest/api/packages.html"
      }
    ],
    "lastReviewedAt": "2026-09-07"
  },
  {
    ...
    "commonMistakes": [
      "كتابة كود يعتمد على حالة مشتركة دون تأمين wrapper موحد للحزمة."
    ],
    "followUpQuestions": [
      "كيف يضمن ملف exports في package.json تجنب تحميل نسختين من نفس الحزمة؟"
    ],
    "sources": [
      {
        "title": "Node.js docs — Dual package hazard",
        "url": "https://nodejs.org/docs/latest/api/packages.html#dual-package-hazard"
      }
    ],
    "lastReviewedAt": "2026-09-07"
  },
  {
    ...
    "commonMistakes": [
      "تثبيت حزم خارجية ضخمة لاختبارات بسيطة بينما المشغل المدمج كافٍ تماماً."
    ],
    "followUpQuestions": [
      "كيف تشغل اختبارات node:test من موجه الأوامر عبر node --test؟"
    ],
    "sources": [
      {
  ...
  },
  {
    ...
    "commonMistakes": [
      "الاعتماد على ^ مع حزم في الإصدارات الصفرية (0.x.x) حيث تختلف قواعد التوافق الدلالي."
    ],
    "followUpQuestions": [
      "كيف يختلف تصرف ^0.2.3 عن ^1.2.3 في معيار SemVer؟"
    ],
    "sources": [
      {
        "title": "Node.js docs — Packages and Semver",
        "url": "https://nodejs.org/docs/latest/api/packages.html"
      }
    ],
    "lastReviewedAt": "2026-09-07"
  },
  {
    ...
    "commonMistakes": [
      "الخلط بين استيراد الحزم الخارجية والوحدات المدمجة دون البادئة الرسمية."
    ],
    "followUpQuestions": [
      "متى بدأت Node.js بدعم بادئة البروتوكول node: وما هي الإصدارات المتوافقة؟"
    ],
    "sources": [
      {
        "title": "Node.js docs — Core modules and node: protocol",
        "url": "https://nodejs.org/docs/latest/api/modules.html#core-modules"
      }
    ],
    "lastReviewedAt": "2026-09-07"
  },
  {
    ...
    "commonMistakes": [
      "محاولة استخدام ميزات تتطلب توليد كود حقيقي مثل enums القديمة مع Type Stripping."
    ],
    "followUpQuestions": [
      "ما القيود البرمجية لميزة Type Stripping مقارنة بالترجمة الكاملة بواسطة tsc؟"
    ],
    "sources": [
      {
        "title": "Node.js docs — Modules: TypeScript and Type Stripping",
        "url": "https://nodejs.org/docs/latest/api/typescript.html"
      }
    ],
    "lastReviewedAt": "2026-09-07"
  },
  {
    ...
    "commonMistakes": [
      "محاولة إرسال res.setHeader() بعد أن تم إرسال الترويسات بالفعل بـ res.write() أو res.end() مما يسبب خطأ Headers already sent."
    ],
    "followUpQuestions": [
      "ما هو الفرق الدقيق بين res.write() و res.end() في node:http؟"
    ],
    "sources": [
      {
  ...
  },
  {
    ...
    "commonMistakes": [
      "حذف المعامل الرابع next من تعريف الـ error handler مما يجعل Express يعامله كـ regular middleware ويتجاهله عند وقوع خطأ."
    ],
    "followUpQuestions": [
      "كيف يتعامل Express 5 مع الـ asynchronous errors مقارنة بـ Express 4؟"
    ],
    "sources": [
      {
        "title": "Node.js docs — HTTP Server response",
        "url": "https://nodejs.org/docs/latest/api/http.html#class-httpserverresponse"
      }
    ],
    "lastReviewedAt": "2026-09-07"
  },
  {
    ...
    "commonMistakes": [
      "عدم تعريف schemas في Fastify مما يفقده أبرز مزاياه الأدائية والتحقق التلقائي."
    ],
    "followUpQuestions": [
      "كيف يضمن نظام الـ Encapsulation والـ Plugins في Fastify عزل النطاقات وسرعة الإقلاع؟"
    ],
    "sources": [
      {
        "title": "Node.js docs — HTTP Benchmarking and Optimization",
        "url": "https://nodejs.org/docs/latest/api/http.html"
      }
    ],
    "lastReviewedAt": "2026-09-07"
  },
  {
    ...
    "commonMistakes": [
      "الاستخدام المفرط للـ Request Scope في NestJS دون حاجة حقيقية مما يرفع استهلاك الذاكرة ويبطئ الاستجابة."
    ],
    "followUpQuestions": [
      "ما الفرق بين الـ Transient Scope والـ Request Scope والـ Default Scope في NestJS؟"
    ],
    "sources": [
      {
        "title": "Node.js docs — Modules design and structure",
  ...
  },
  {
    ...
    "commonMistakes": [
      "الاعتماد على أنواع TypeScript وحدها للتحقق، متناسين أن TypeScript تُمحى تماماً وقت التشغيل."
    ],
    "followUpQuestions": [
      "كيف تدمج التحقق التلقائي في Express middleware لإرجاع رسائل أخطاء موحدة؟"
    ],
    "sources": [
      {
        "title": "Node.js docs — Errors and Validations",
        "url": "https://nodejs.org/docs/latest/api/errors.html"
      }
    ],
    "lastReviewedAt": "2026-09-07"
  },
  {
    ...
    "commonMistakes": [
      "تجاهل فحص ترويسة Content-Type للطلب ومحاولة تحليل جسم الطلب كـ JSON وهو نص عادي أو multipart."
    ],
    "followUpQuestions": [
      "كيف تساعد مكتبات مثل accepts في التعامل مع ترويسات التفاوض المعقدة؟"
    ],
    "sources": [
      {
        "title": "Node.js docs — HTTP Headers",
        "url": "https://nodejs.org/docs/latest/api/http.html#messageheaders"
      }
    ],
    "lastReviewedAt": "2026-09-07"
  },
  {
    ...
    "commonMistakes": [
      "إغفال تطبيق الـ Ping/Pong مما يتسبب في بقاء آلاف المقابس الميتة مفتوحة في السيرفر وتآكل الذاكرة."
    ],
    "followUpQuestions": [
      "كيف توزع اتصالات WebSockets عبر عدة خوادم باستخدام Redis Pub/Sub؟"
    ],
    "sources": [
      {
        "title": "Node.js docs — HTTP Upgrade Event",
        "url": "https://nodejs.org/docs/latest/api/http.html#event-upgrade"
      }
    ],
    "lastReviewedAt": "2026-09-07"
  },
  {
    ...
    "commonMistakes": [
      "الاعتماد على mimetype القادم من المتصفح للتحقق من أمان الملف المرفوع."
    ],
    "followUpQuestions": [
      "كيف تفحص الـ Magic Numbers للبايتات الأولى للملف للتأكد من هويته الحقيقية؟"
    ],
    "sources": [
      {
        "title": "Node.js docs — Stream processing for network uploads",
        "url": "https://nodejs.org/docs/latest/api/stream.html"
      }
    ],
    "lastReviewedAt": "2026-09-07"
  },
  {
    ...
    "commonMistakes": [
      "تخزين عدادات الـ Rate Limiting في ذاكرة التطبيق المحلية عند تشغيل عدة نسخ (Clustered) مما يجعل الحظر غير فعال."
    ],
    "followUpQuestions": [
      "ما الفرق بين خوارزمية Fixed Window وخوارزمية Sliding Window Counter في الـ Rate Limiting؟"
    ],
    "sources": [
      {
        "title": "Node.js docs — server.headersTimeout",
        "url": "https://nodejs.org/docs/latest/api/http.html#serverheaderstimeout"
      }
    ],
    "lastReviewedAt": "2026-09-07"
  },
  {
    ...
    "commonMistakes": [
      "نسيان إغلاق الاتصال عند إغلاق العميل للصفحة عبر الاستماع لحدث req.on('close')."
    ],
    "followUpQuestions": [
      "كيف يؤثر حد الـ 6 اتصالات المتزامنة في بروتوكول HTTP/1.1 على استخدامات SSE؟"
    ],
    "sources": [
      {
        "title": "Node.js docs — HTTP Server response write",
        "url": "https://nodejs.org/docs/latest/api/http.html#responsewritechunk-encoding-callback"
      }
    ],
    "lastReviewedAt": "2026-09-07"
  },
  {
    ...
    "commonMistakes": [
      "نسيان استدعاء client.release() داخل كتلة finally مما يفرغ الـ pool بسرعة ويسقط السيرفر."
    ],
    "followUpQuestions": [
      "كيف تحدد الحجم الأمثل لحمام الاتصالات بناءً على عدد أنوية قاعدة البيانات وتطبيقات السيرفر؟"
    ],
    "sources": [
      {
        "title": "Node.js docs — Database Best Practices and Net Sockets",
        "url": "https://nodejs.org/docs/latest/api/net.html"
      }
    ],
    "lastReviewedAt": "2026-09-07"
  },
  {
    ...
    "commonMistakes": [
      "إنشاء نُسخ متعددة من PrismaClient في كل ملف أو دالة بدلاً من مشاركة نسخة Singleton واحدة."
    ],
    "followUpQuestions": [
      "ما هو تأثير حجم المحرك الثنائي لـ Prisma على وظائف الـ Serverless (AWS Lambda)؟"
    ],
    "sources": [
      {
        "title": "Node.js docs — Process execution and binaries",
  ...
  },
  {
    ...
    "commonMistakes": [
      "الاعتماد المفرط على ميزات الـ Eager Loading التلقائية في TypeORM مما يولد استعلامات SQL ضخمة غير فعالة."
    ],
    "followUpQuestions": [
      "كيف يدعم Drizzle استنتاج أنواع TypeScript دون الحاجة لتوليد كود (Code Generation)؟"
    ],
    "sources": [
      {
        "title": "Node.js docs — TypeScript Integration",
        "url": "https://nodejs.org/docs/latest/api/typescript.html"
      }
    ],
    "lastReviewedAt": "2026-09-07"
  },
  {
    ...
    "commonMistakes": [
      "عدم تعطيل command buffering في بيئات الـ Serverless مما يؤدي لتعليق الوظائف السحابية."
    ],
    "followUpQuestions": [
      "ما أهمية استخدام .lean() في استعلامات Mongoose لتحسين سرعة القراءة والذاكرة؟"
    ],
    "sources": [
      {
        "title": "Node.js docs — net module and sockets",
        "url": "https://nodejs.org/docs/latest/api/net.html"
      }
    ],
    "lastReviewedAt": "2026-09-07"
  },
  {
    ...
    "commonMistakes": [
      "استخدام الـ string interpolation مع مكتبات قواعد البيانات بحجة أن المدخلات مفحوصة."
    ],
    "followUpQuestions": [
      "كيف تتعامل مع الأسماء الديناميكية للأعمدة والجداول التي لا تقبل الـ Parameterized values؟"
    ],
    "sources": [
      {
  ...
  },
  {
    ...
    "commonMistakes": [
      "تنفيذ أوامر BEGIN و COMMIT عبر pool.query المباشر بدلاً من عميل مخصص محجوز."
    ],
    "followUpQuestions": [
      "ما الفرق بين مستويات العزل Read Committed و Serializable ومتى تحتاج الأخير؟"
    ],
    "sources": [
      {
        "title": "Node.js docs — Client Pool Interactions",
        "url": "https://nodejs.org/docs/latest/api/net.html"
      }
    ],
    "lastReviewedAt": "2026-09-07"
  },
  {
    ...
    "commonMistakes": [
      "إعادة استخدام نفس كائن DataLoader عبر طلبات مستخدمين مختلفين مما يسرب البيانات المخزنة مؤقتاً."
    ],
    "followUpQuestions": [
      "لماذا يجب إنشاء كائن DataLoader جديد لكل طلب HTTP مستقل؟"
    ],
    "sources": [
      {
        "title": "Node.js docs — Event loop tick batching",
        "url": "https://nodejs.org/docs/latest/api/process.html#processnexttickcallback-args"
      }
    ],
    "lastReviewedAt": "2026-09-07"
  },
  {
    ...
    "commonMistakes": [
      "توجيه استعلامات القراءة داخل المعاملات المفتوحة إلى الـ Replicas مما يفشل المعاملة."
    ],
    "followUpQuestions": [
      "كيف تدير ظاهرة الـ Replication Lag وتضمن قراءة المستخدم لأحدث بياناته؟"
    ],
    "sources": [
      {
        "title": "Node.js docs — Cluster and networking architecture",
        "url": "https://nodejs.org/docs/latest/api/net.html"
      }
    ],
    "lastReviewedAt": "2026-09-07"
  },
  {
    ...
    "commonMistakes": [
      "إجراء تعديلات حصرية تقفل الجداول الكبيرة (Table Lock) مثل إضافة أعمدة بقيم افتراضية غير متوافقة."
    ],
    "followUpQuestions": [
      "كيف تتأكد من عدم قفل الجداول الكبيرة (Exclusive Locks) أثناء إنشاء الفهارس (Indexes) بـ PostgreSQL؟"
    ],
    "sources": [
      {
        "title": "Node.js docs — Database deployment practices",
        "url": "https://nodejs.org/docs/latest/api/process.html"
      }
    ],
    "lastReviewedAt": "2026-09-07"
  },
  {
    ...
    "commonMistakes": [
      "تحرير القفل بأمر DEL البسيط دون التحقق من أن الـ token لا يزال يخص العملية الحالية."
    ],
    "followUpQuestions": [
      "متى تحتاج لاستخدام خوارزمية Redlock مع مجموعات Redis المتعددة؟"
    ],
    "sources": [
      {
        "title": "Node.js docs — Crypto randomBytes for lock tokens",
        "url": "https://nodejs.org/docs/latest/api/crypto.html#cryptorandombytesize-callback"
      }
    ],
    "lastReviewedAt": "2026-09-07"
  },
  {
    ...
    "commonMistakes": [
      "عدم تحديد قائمة الخوارزميات المسموحة في خيارات verify مما يعرض التطبيق لثغرة None Algorithm."
    ],
    "followUpQuestions": [
      "كيف تحمي الخادم من هجمات التراجع (Algorithm Confusion Attack) بين HMAC و RSA؟"
    ],
    "sources": [
      {
        "title": "Node.js docs — Crypto module and key pairs",
        "url": "https://nodejs.org/docs/latest/api/crypto.html#cryptogeneratekeypairsynctype-options"
      }
    ],
    "lastReviewedAt": "2026-09-07"
  },
  {
    ...
    "commonMistakes": [
      "تخزين رموز المصادقة والـ Refresh Tokens في localStorage بالمتصفح مما يجعلها عرضة للسرقة المباشرة عبر XSS."
    ],
    "followUpQuestions": [
      "كيف تصمم هيكل عائلة الرموز (Token Family) لاكتشاف سرقة الرموز في قاعدة البيانات؟"
    ],
    "sources": [
      {
        "title": "Node.js docs — HTTP Cookies and Headers",
        "url": "https://nodejs.org/docs/latest/api/http.html"
      }
    ],
    "lastReviewedAt": "2026-09-07"
  },
  {
    ...
    "commonMistakes": [
      "استخدام MD5 أو SHA-256 البسيطة لحفظ كلمات المرور."
    ],
    "followUpQuestions": [
      "ما هو معامل الصعوبة (Work Factor) الموصى به لـ bcrypt على خوادم الإنتاج اليوم؟"
    ],
    "sources": [
      {
        "title": "Node.js docs — Crypto module and scrypt",
        "url": "https://nodejs.org/docs/latest/api/crypto.html#cryptoscryptpassword-salt-keylen-options-callback"
      }
    ],
    "lastReviewedAt": "2026-09-07"
  },
  {
    ...
    "commonMistakes": [
      "الاعتماد على SameSite=None دون تطبيق تحقق يدوي من الـ CSRF Tokens."
    ],
    "followUpQuestions": [
      "هل تحتاج واجهات برمجة التطبيقات المبنية بالكامل على ترويسة Authorization: Bearer إلى حماية ضد CSRF؟"
    ],
    "sources": [
      {
        "title": "Node.js docs — Web Security Considerations",
        "url": "https://nodejs.org/docs/latest/api/http.html"
      }
    ],
    "lastReviewedAt": "2026-09-07"
  },
  {
    ...
    "commonMistakes": [
      "تعيين Access-Control-Allow-Origin: * مع تفعيل credentials: true وهو ما ترفضه المتصفحات أمنياً."
    ],
    "followUpQuestions": [
      "لماذا لا تحمي سياسة CORS خوادم الـ Backend من طلبات أدوات مثل Postman أو curl؟"
    ],
    "sources": [
      {
        "title": "Node.js docs — HTTP Headers and Options requests",
        "url": "https://nodejs.org/docs/latest/api/http.html"
      }
    ],
    "lastReviewedAt": "2026-09-07"
  },
  {
    ...
    "commonMistakes": [
      "ترك ترويسة X-Powered-By: Express ظاهرة للعامة مما يسهل على المهاجمين استهداف ثغرات الإصدار الخاص بك."
    ],
    "followUpQuestions": [
      "كيف تقوم بضبط سياسة Content-Security-Policy (CSP) المخصصة مع الـ Nonce للسكريبتات المضمنة؟"
    ],
    "sources": [
      {
        "title": "Node.js docs — Security Best Practices",
  ...
  },
  {
    ...
    "commonMistakes": [
      "استخدام دوال دمج الكائنات (Object deep merge) غير الموثوقة لمدخلات المستخدمين المباشرة."
    ],
    "followUpQuestions": [
      "كيف تحظر Node.js معالجة __proto__ عبر راية التشغيل --disable-proto=delete؟"
    ],
    "sources": [
      {
        "title": "Node.js docs — Command-line options: disable-proto",
        "url": "https://nodejs.org/docs/latest/api/cli.html#--disable-protomode"
      }
    ],
    "lastReviewedAt": "2026-09-07"
  },
  {
    ...
    "commonMistakes": [
      "رفع ملف .env يحتوي أسراراً حقيقية إلى مستودع Git العام أو تضمينه في صور Docker العامة."
    ],
    "followUpQuestions": [
      "كيف تستخدم أدوات مثل HashiCorp Vault أو AWS Secrets Manager لتحميل الأسرار ديناميكياً؟"
    ],
    "sources": [
      {
        "title": "Node.js docs — Command-line options: env-file",
        "url": "https://nodejs.org/docs/latest/api/cli.html#--env-fileconfig"
      }
    ],
    "lastReviewedAt": "2026-09-07"
  },
  {
    ...
    "commonMistakes": [
      "مقارنة تواقيع الـ Webhooks (مثل Stripe أو GitHub) باستخدام عامل المساواة العادي ===."
    ],
    "followUpQuestions": [
      "ما الشرط الضروري الذي تفرضه دالة crypto.timingSafeEqual على طول الـ Buffers قبل المقارنة؟"
    ],
    "sources": [
      {
        "title": "Node.js docs — crypto.timingSafeEqual",
        "url": "https://nodejs.org/docs/latest/api/crypto.html#cryptotimingsafeequalba-bb"
      }
    ],
    "lastReviewedAt": "2026-09-07"
  },
  {
    ...
    "commonMistakes": [
      "تثبيت حزم غير معروفة ذات عدد تحميلات قليل دون مراجعة كودها المصدري وترخيصها."
    ],
    "followUpQuestions": [
      "ما هي ميزة npm provenance وكيف تؤكد أن الحزمة بُنيت بالفعل من المستودع الرسمي المعلن؟"
    ],
    "sources": [
      {
        "title": "Node.js docs — Security Best Practices",
  ...
  },
  {
    ...
    "commonMistakes": [
      "مشاركة الذاكرة المباشرة بين الـ Worker processes دون استخدام وسيط موزع كـ Redis أو رسائل IPC."
    ],
    "followUpQuestions": [
      "ما الفرق بين خوارزمية Round-Robin ومخطط توزيع نظام التشغيل للاتصالات في الـ Cluster؟"
    ],
    "sources": [
      {
        "title": "Node.js docs — Cluster",
        "url": "https://nodejs.org/docs/latest/api/cluster.html"
      }
    ],
    "lastReviewedAt": "2026-09-07"
  },
  {
    ...
    "commonMistakes": [
      "استخدام Worker Threads لمهام الـ I/O العادية التي تبرع فيها Node.js بالفعل، مما يضيف تكلفة إدارة الخيوط بلا فائدة."
    ],
    "followUpQuestions": [
      "كيف تتجنب أخطاء التسابق (Race Conditions) عند استخدام SharedArrayBuffer بواسطة كائن Atomics؟"
    ],
    "sources": [
      {
        "title": "Node.js docs — Worker threads",
        "url": "https://nodejs.org/docs/latest/api/worker_threads.html"
      }
    ],
    "lastReviewedAt": "2026-09-07"
  },
  {
    ...
    "commonMistakes": [
      "أخذ لقطات الـ Heap في بيئة الإنتاج أثناء ذروة الاستخدام العالية مما يجمد السيرفر لعدة ثوانٍ."
    ],
    "followUpQuestions": [
      "ما الفرق بين الـ Shallow Size والـ Retained Size لكائن في لقطة الذاكرة؟"
    ],
    "sources": [
      {
        "title": "Node.js docs — v8.writeHeapSnapshot",
        "url": "https://nodejs.org/docs/latest/api/v8.html#v8writeheapsnapshotfilename"
      }
    ],
    "lastReviewedAt": "2026-09-07"
  },
  {
    ...
    "commonMistakes": [
      "الافتراض بأن بطء التطبيق سببه دوال الـ CPU دون فحص أزمنة انتظار الـ I/O أولاً."
    ],
    "followUpQuestions": [
      "كيف تحلل ملفات الـ cpuprofile المولدة داخل لوحة Performance في أدوات مطوري المتصفح؟"
    ],
    "sources": [
      {
        "title": "Node.js docs — Profiling and Performance hooks",
        "url": "https://nodejs.org/docs/latest/api/perf_hooks.html"
      }
    ],
    "lastReviewedAt": "2026-09-07"
  },
  {
    ...
    "commonMistakes": [
      "عدم تحديد حد أقصى للاتصالات (maxSockets) مما قد يستنزف موارد الخادم البعيد."
    ],
    "followUpQuestions": [
      "كيف يدعم fetch الأصيل في Node.js إدارة اتصالات الـ keepAlive تلقائياً عبر undici؟"
    ],
    "sources": [
      {
        "title": "Node.js docs — http.Agent keepAlive",
        "url": "https://nodejs.org/docs/latest/api/http.html#new-agentoptions"
      }
    ],
    "lastReviewedAt": "2026-09-07"
  },
  {
    ...
    "commonMistakes": [
      "تخزين الكائنات في الـ Cache دون تعيين TTL مما يسبب تضخم الذاكرة وتقديم بيانات غير متزامنة للأبد."
    ],
    "followUpQuestions": [
      "ما هي ظاهرة الـ Cache Stampede (Dog-piling) وكيف تحمي قاعدة البيانات منها؟"
    ],
    "sources": [
      {
        "title": "Node.js docs — Performance and caching concepts",
        "url": "https://nodejs.org/docs/latest/api/perf_hooks.html"
      }
    ],
    "lastReviewedAt": "2026-09-07"
  },
  {
    ...
    "commonMistakes": [
      "تعيين الحد بقيمة مساوية لذاكرة الحاوية تماماً مع نسيان استهلاك الذاكرة خارج الـ Heap (مثل Buffers وخيوط الـ C++)."
    ],
    "followUpQuestions": [
      "كيف تراقب توقفات الـ Garbage Collection عبر PerformanceObserver و node:perf_hooks؟"
    ],
    "sources": [
      {
        "title": "Node.js docs — Command-line options: max-old-space-size",
        "url": "https://nodejs.org/docs/latest/api/cli.html#--max-old-space-sizesize-in-megabytes"
      }
    ],
    "lastReviewedAt": "2026-09-07"
  },
  {
    ...
    "commonMistakes": [
      "تسلسل كائنات ضخمة جداً متزامناً داخل الخيط الرئيسي بدلاً من تدفقها عبر streaming JSON parsers."
    ],
    "followUpQuestions": [
      "متى يجب استخدام JSONStream لتدفق نتائج قواعد البيانات الكبيرة مباشرة إلى العميل؟"
    ],
    "sources": [
      {
        "title": "Node.js docs — Don't Block the Event Loop",
  ...
  },
  {
    ...
    "commonMistakes": [
      "توقع حل مشكلة تجويع الـ threadpool لمهام الـ CPU الصرفة؛ الـ threadpool مخصص فقط لمهام libuv وليس لأي كود JavaScript عادي."
    ],
    "followUpQuestions": [
      "ما الفرق بين dns.lookup المعتمد على الـ threadpool و dns.resolve الذي يستخدم c-ares غير الحاجم؟"
    ],
    "sources": [
      {
        "title": "Node.js docs — DNS and libuv threadpool",
        "url": "https://nodejs.org/docs/latest/api/dns.html#implementation-considerations"
      }
    ],
    "lastReviewedAt": "2026-09-07"
  },
  {
    ...
    "commonMistakes": [
      "استخدام pm2 restart بدلاً من pm2 reload أثناء التحديثات، مما يقطع الخدمة مؤقتاً عن جميع المستخدمين."
    ],
    "followUpQuestions": [
      "كيف يتم جمع وتدوير ملفات السجلات (Log Rotation) في PM2؟"
    ],
    "sources": [
      {
        "title": "Node.js docs — Cluster and process management",
        "url": "https://nodejs.org/docs/latest/api/cluster.html"
      }
    ],
    "lastReviewedAt": "2026-09-07"
  },
  {
    ...
    "commonMistakes": [
      "نسيان await أمام assert.rejects مما يجعل الاختبار ينتهي مبكراً دون التحقق الحقيقي من الخطأ."
    ],
    "followUpQuestions": [
      "كيف تضبط مهل الاختبارات الفردية (Test Timeouts) لتفادي تعليق الـ CI؟"
    ],
    "sources": [
      {
        "title": "Node.js docs — assert.rejects",
        "url": "https://nodejs.org/docs/latest/api/assert.html#assertrejectsasyncfn-error-message"
      }
    ],
    "lastReviewedAt": "2026-09-07"
  },
  {
    ...
    "commonMistakes": [
      "تصدير السيرفر وهو يستمع بالفعل لمنفذ ثابت (app.listen(3000)) داخل ملف التطبيق الرئيسي بدلاً من فصل تعريف الـ app عن تشغيل الـ server."
    ],
    "followUpQuestions": [
      "لماذا يجب فصل ملف app.ts عن server.ts لتسهيل الاختبارات التكاملية؟"
    ],
    "sources": [
      {
        "title": "Node.js docs — net.Server listen on port 0",
        "url": "https://nodejs.org/docs/latest/api/net.html#serverlistenport-host-backlog-callback"
      }
    ],
    "lastReviewedAt": "2026-09-07"
  },
  {
    ...
    "commonMistakes": [
      "نسيان تنظيف الـ Mocks بعد كل اختبار مما يسبب تداخل النتائج بين الاختبارات المتتالية."
    ],
    "followUpQuestions": [
      "كيف تضمن دالة nock.isDone() أن كل الاستدعاءات المتوقعة قد تمت بالفعل قبل نهاية الاختبار؟"
    ],
    "sources": [
      {
        "title": "Node.js docs — http.request client API",
        "url": "https://nodejs.org/docs/latest/api/http.html#httprequestoptions-callback"
      }
    ],
    "lastReviewedAt": "2026-09-07"
  },
  {
    ...
    "commonMistakes": [
      "إعادة إنشاء حاوية Docker جديدة لكل اختبار فردي مما يرفع زمن تنفيذ الـ suite لعشرات الدقائق بدلاً من مشاركتها."
    ],
    "followUpQuestions": [
      "كيف تشارك حاوية واحدة عبر جميع الاختبارات مع مسح البيانات (Truncate) بين الاختبارات؟"
    ],
    "sources": [
      {
        "title": "Node.js docs — Child process and container orchestration",
        "url": "https://nodejs.org/docs/latest/api/child_process.html"
      }
    ],
    "lastReviewedAt": "2026-09-07"
  },
  {
    ...
    "commonMistakes": [
      "تنفيذ العمليات المتزامنة في حلقة for عادية مما يجعلها تنفذ متسلسلة وتفشل في كشف ظروف التسابق."
    ],
    "followUpQuestions": [
      "كيف يساعد استخدام SELECT FOR UPDATE في SQL على منع تضارب الأرصدة في هذه الاختبارات؟"
    ],
    "sources": [
      {
        "title": "Node.js docs — Asynchronous concurrency",
        "url": "https://nodejs.org/docs/latest/api/async_context.html"
      }
    ],
    "lastReviewedAt": "2026-09-07"
  },
  {
    ...
    "commonMistakes": [
      "استخدام Contract Testing كبديل كامل لاختبارات الوحدة للمنطق الداخلي؛ هو مخصص فقط لحدود التواصل."
    ],
    "followUpQuestions": [
      "ما الفرق بين Contract Testing والتحقق بواسطة OpenAPI / Swagger schemas؟"
    ],
    "sources": [
      {
        "title": "Node.js docs — Testing concepts",
        "url": "https://nodejs.org/docs/latest/api/test.html"
      }
    ],
    "lastReviewedAt": "2026-09-07"
  },
  {
    ...
    "commonMistakes": [
      "بناء هرم اختبارات مقلوب بحيث تكون معظم الاختبارات E2E مما يبطئ دورة التطوير بشكل هائل."
    ],
    "followUpQuestions": [
      "كيف تحافظ على استقرار بيانات الاختبار في بيئات الـ E2E لتفادي النتائج المتذبذبة؟"
    ],
    "sources": [
      {
        "title": "Node.js docs — Test runner execution",
        "url": "https://nodejs.org/docs/latest/api/test.html"
      }
    ],
    "lastReviewedAt": "2026-09-07"
  },
  {
    ...
    "commonMistakes": [
      "السعي وراء رقم 100% Code Coverage والتركيز على السطور التافهة بدلاً من الحالات الحدية الخطيرة."
    ],
    "followUpQuestions": [
      "كيف تعمل راية --experimental-test-coverage المدمجة في Node.js لجمع تقارير lcov؟"
    ],
    "sources": [
      {
        "title": "Node.js docs — Test runner code coverage",
        "url": "https://nodejs.org/docs/latest/api/test.html#code-coverage"
      }
    ],
    "lastReviewedAt": "2026-09-07"
  },
  {
    ...
    "commonMistakes": [
      "عدم وضع timeout عند انتظار أحداث الـ stream مما يؤدي لتعليق مشغل الاختبارات للأبد عند فشل الحدث."
    ],
    "followUpQuestions": [
      "كيف تختبر إطلاق أحداث الخطأ 'error' على Stream دون انهيار بيئة الاختبار؟"
    ],
    "sources": [
      {
        "title": "Node.js docs — events.once",
        "url": "https://nodejs.org/docs/latest/api/events.html#eventsonceemitter-name-options"
      }
    ],
    "lastReviewedAt": "2026-09-07"
  },
  {
    ...
    "commonMistakes": [
      "وضع setTimeout(..., 2000) في الاختبار بافتراض أن العملية ستنتهي حتماً في ثانيتين، وهو ما يفشل على خوادم الـ CI البطيئة."
    ],
    "followUpQuestions": [
      "كيف تستخدم ميزة test.mock.timers المدمجة في Node.js لاختبار الفواصل الزمنية بدقة؟"
    ],
    "sources": [
      {
        "title": "Node.js docs — Mocking Timers",
        "url": "https://nodejs.org/docs/latest/api/test.html#mock-timers"
      }
    ],
    "lastReviewedAt": "2026-09-07"
  },
  {
    ...
    "commonMistakes": [
      "استيراد نماذج قواعد البيانات (مثل نماذج Mongoose أو TypeORM) مباشرة داخل طبقة الـ Use Cases."
    ],
    "followUpQuestions": [
      "كيف تسهل المعمارية النظيفة استبدال إطار عمل السيرفر دون لمس منطق الأعمال؟"
    ],
    "sources": [
      {
        "title": "Node.js docs — Architectural Design Patterns",
        "url": "https://nodejs.org/docs/latest/api/modules.html"
      }
    ],
    "lastReviewedAt": "2026-09-07"
  },
  {
    ...
    "commonMistakes": [
      "معالجة مهام طويلة ومعقدة مباشرة داخل مسار الـ HTTP Request بدلاً من ترحيلها لطابور مهام."
    ],
    "followUpQuestions": [
      "كيف تتعامل مع مشكلة الـ Dead Letter Queue (DLQ) للمهام التي تفشل باستمرار؟"
    ],
    "sources": [
      {
        "title": "Node.js docs — Events and Streams in Background Processing",
        "url": "https://nodejs.org/docs/latest/api/events.html"
      }
    ],
    "lastReviewedAt": "2026-09-07"
  },
  {
    ...
    "commonMistakes": [
      "إضافة عدد مستهلكين في نفس المجموعة يفوق عدد الـ Partitions، مما يترك الخوادم الإضافية في حالة خمول."
    ],
    "followUpQuestions": [
      "ما هو دور الـ Consumer Rebalancing وكيف يؤثر على زمن معالجة الأحداث؟"
    ],
    "sources": [
      {
        "title": "Node.js docs — Stream consumers and networking",
        "url": "https://nodejs.org/docs/latest/api/stream.html"
      }
    ],
    "lastReviewedAt": "2026-09-07"
  },
  {
    ...
    "commonMistakes": [
      "استخدام gRPC للواجهات العامة الموجهة للمتصفحات العادية التي تفتقر للدعم الأصيل لـ HTTP/2 gRPC."
    ],
    "followUpQuestions": [
      "كيف يدعم gRPC ميزة الـ Multiplexing الموروثة من بروتوكول HTTP/2؟"
    ],
    "sources": [
      {
        "title": "Node.js docs — HTTP/2 Module",
        "url": "https://nodejs.org/docs/latest/api/http2.html"
      }
    ],
    "lastReviewedAt": "2026-09-07"
  },
  {
    ...
    "commonMistakes": [
      "عدم توفير مسار استجابة بديل (Fallback) واضح عند فتح الدائرة."
    ],
    "followUpQuestions": [
      "كيف يحدد قاطع الدائرة الانتقال من حالة Open إلى Half-Open؟"
    ],
    "sources": [
      {
        "title": "Node.js docs — Error boundaries and resilience",
        "url": "https://nodejs.org/docs/latest/api/errors.html"
      }
    ],
    "lastReviewedAt": "2026-09-07"
  },
  {
    ...
    "commonMistakes": [
      "فقدان تمرير ترويسة traceparent عند استدعاء الخدمات الخارجية عبر عميل الـ HTTP."
    ],
    "followUpQuestions": [
      "كيف يرتبط OpenTelemetry مع فئة AsyncLocalStorage لنقل سياق الـ Tracing داخل الخادم الواحد؟"
    ],
    "sources": [
      {
        "title": "Node.js docs — Async Context Tracing",
        "url": "https://nodejs.org/docs/latest/api/async_context.html"
      }
    ],
    "lastReviewedAt": "2026-09-07"
  },
  {
    ...
    "commonMistakes": [
      "استخدام console.log في مسارات معالجة الطلبات عالية الكثافة، متناسين أن console.log متزامن في بعض البيئات ويحجب الخيط."
    ],
    "followUpQuestions": [
      "ما الفرق الأدائي بين الكتابة المتزامنة في stdout واستخدام pino.transport للمعالجة غير المتزامنة؟"
    ],
    "sources": [
      {
        "title": "Node.js docs — Console and stdio",
        "url": "https://nodejs.org/docs/latest/api/console.html"
      }
    ],
    "lastReviewedAt": "2026-09-07"
  },
  {
    ...
    "commonMistakes": [
      "ربط فحص الـ Liveness بقاعدة بيانات خارجية؛ فإذا سقطت قاعدة البيانات، سيعيد Kubernetes قتل وإعادة تشغيل كل خوادم Node.js عبثاً."
    ],
    "followUpQuestions": [
      "كيف تصمم مسار Startup Probe لحماية تطبيقات Node.js التي تستغرق وقتاً طويلاً في التحميل الأولي؟"
    ],
    "sources": [
      {
        "title": "Node.js docs — Process health and signals",
        "url": "https://nodejs.org/docs/latest/api/process.html"
      }
    ],
    "lastReviewedAt": "2026-09-07"
  },
  {
    ...
    "commonMistakes": [
      "نسخ مجلد node_modules بالكامل من جهاز التطوير إلى داخل صورة Docker."
    ],
    "followUpQuestions": [
      "لماذا لا تستجيب Node.js افتراضياً لإشارات SIGTERM عندما تعمل كـ PID 1 مباشرة دون init system؟"
    ],
    "sources": [
      {
        "title": "Node.js docs — Docker and Container guidance",
        "url": "https://nodejs.org/docs/latest/api/process.html#signal-events"
      }
    ],
    "lastReviewedAt": "2026-09-07"
  },
  {
    ...
    "commonMistakes": [
      "الاعتماد على افتراض أن أنظمة الرسائل لن تسلم نفس الرسالة مطلقاً أكثر من مرة."
    ],
    "followUpQuestions": [
      "كيف تطبق نمط Outbox Pattern لضمان نشر الأحداث وقيد المعاملات ذريةً في قاعدة البيانات؟"
    ],
    "sources": [
      {
        "title": "Node.js docs — Transactional integrity in event-driven systems",
        "url": "https://nodejs.org/docs/latest/api/events.html"
      }
    ],
    "lastReviewedAt": "2026-09-07"
